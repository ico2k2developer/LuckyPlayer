...
public class ViewHandle extends RecyclerView.ViewHolder
{
    ...
    public void setOnContextMenuListener(final OnItemContextMenuListener listener,
                                         final int position)
    {
    ...
    {
        void onContextMenu(ContextMenu menu,View v,ContextMenu.ContextMenuInfo menuInfo,
                           int position);
    }
}